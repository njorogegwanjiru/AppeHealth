...
public class PatientRegistration extends AppCompatActivity {
        ...
        register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (TextUtils.isEmpty(fname) |
                    ...
                    Toast.makeText(PatientRegistration.this, "All fields marked * are required!", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(PatientRegistration.this, "The Passwords should be between 6-10 characters", Toast.LENGTH_LONG).show();
                } else {
                    register(fname, mname, lname, email, phone, dob, sex, pass2, usertype);
                }
            }
        });
    ...
    private void register(final String fname, final String mname, final String lname, final String email, final String phone, final String dob, final String sex, String password, final String usertype) {
        pd.show();
                ...
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            hashMap.put("Type", String.valueOf(usertype));
                            pd.dismiss();
                            ...
                            reference.setValue(hashMap).addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Intent intent = new Intent(PatientRegistration.this, All_Patients.class);
